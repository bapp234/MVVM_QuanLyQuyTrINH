    ...
    namespace MVVM_QuanLyQuyTrINH.Models.Context
    {
        public partial class QLQuyTrinhLamViecContext : DbContext
        {
            ...
            .HasConstraintName("FK_DuAn_QuanLy");
                });
            ...
            modelBuilder.Entity<YeuCauDatLaiMatKhau>(entity =>
            {
                entity.ToTable("YeuCauDatLaiMatKhau");

                entity.HasKey(e => e.YeuCauID);

                entity.Property(e => e.YeuCauID).HasColumnName("MaYeuCau");
